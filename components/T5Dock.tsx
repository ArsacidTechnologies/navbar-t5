...
export const T5Dock = ({
  ...
  return (
    <>
      <T5DockDesktop items={items} className={desktopClassName} />
      <T5DockMobile items={items} className={mobileClassName} />
    </>
  );
};
        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute -top-14 left-1/2 w-fit -translate-x-1/2 whitespace-pre rounded-md border border-gray-200 bg-gray-100 px-2 py-0.5 text-xl font-semibold text-neutral-700"
            >
              {title}
            </motion.div>
          )}
